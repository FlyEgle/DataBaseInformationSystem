"""
删除数据库中的信息，按两种方式进行删除，一个是按编号删除，一个是按名称删除
"""
import sys
...
# 社团信息
class SheTuanInfoDeleteDataBase(QDialog):
    def __init__(self):
        super(SheTuanInfoDeleteDataBase, self).__init__()
    ...
    def init_gui(self):
        ...
        self.titlelbl = QLabel('删除数据', self)
...
# 财务管理
class CaiWuManageDeleteDataBase(QDialog):
    def __init__(self):
        super(CaiWuManageDeleteDataBase, self).__init__()
    ...
    def init_gui(self):
        ...
        # save button
        self.save_btn = QPushButton('删除', self)
        self.save_btn.move((self.width() - self.save_btn.width()) / 2, 100)
...
# 社员
class SheYuanDeleteDataBase(QDialog):
    def __init__(self):
        super(SheYuanDeleteDataBase, self).__init__()
...
# 活动信息
class HuodongDeleteDataBase(QDialog):
    def __init__(self):
        super(HuodongDeleteDataBase, self).__init__()
        self.label_dict = {
...
# 社团团长
class SheTuanTuanZhangDeleteDataBase(QDialog):
    def __init__(self):
        super(SheTuanTuanZhangDeleteDataBase, self).__init__()
        self.label_dict = {
...
# 合作单位
class HeZuoDanWeiDeleteDataBase(QDialog):
    def __init__(self):
        super(HeZuoDanWeiDeleteDataBase, self).__init__()
        self.label_dict = {
...
# 指导老师
class ZhiDaoLaoshiDeleteDataBase(QDialog):
    def __init__(self):
        super(ZhiDaoLaoshiDeleteDataBase, self).__init__()
        self.label_dict = {
            '教师编号': 'teacher_id',
            '教师名': 'teacher_name'
        }
...
# 系统删除
class SystemDeleteDataBase(QDialog):
    def __init__(self):
        super(SystemDeleteDataBase, self).__init__()
        self.label_dict = {
            '系统编号': 'system_id',
            '系统账号': 'system_account'
        }
    ...
    def clicked_method(self):
        ...
        for key, value in self.label_dict.items():
            if text == key:
                ...
                break
        self.get_data_index = text_string
        print(self.get_data_index, self.get_data_value)
        self.close()


if __name__ == '__main__':
    app = QApplication(sys.argv)
    deleteDB = SystemDeleteDataBase()
    sys.exit(app.exec_())
